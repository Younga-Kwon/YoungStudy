package Object.com.hw1.run;

import Object.com.hw1.model.vo.Product;
...
public class ProductTest {
	...
	public static void main(String[] args) {
		...
		// 실제가격 = 가격 + (가격 * 부가세율) 
		int price1 = p1.getPrice() + (int)(p1.getPrice() * p1.getTax());
		int price2 = p2.getPrice() + (int)(p2.getPrice() * p2.getTax());
		int price3 = p3.getPrice() + (int)(p3.getPrice() * p3.getTax());
		
		System.out.println("상품명 = " + p1.getProductName());
		System.out.println("부가세 포함 가격 = " + price1);
		System.out.println("상품명 = " + p2.getProductName());
		System.out.println("부가세 포함 가격 = " + price2);
		System.out.println("상품명 = " + p3.getProductName());
		System.out.println("부가세 포함 가격 = " + price3);
